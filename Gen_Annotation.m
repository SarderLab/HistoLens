...
if strcmp(current_tab.Title,'Red Comp Image')
    ...
    if ~app.Comparing
        img_name = app.Full_Feature_set.(app.Structure_Idx_Name).ImgLabel{find(strcmp(app.Image_Name_Label.Items,app.Image_Name_Label.Value))};
    else
        img_name = app.Full_Feature_set.(app.Structure_Idx_Name).ImgLabel{find(strcmp(app.Red_Comp_Image.Items,app.Red_Comp_Image.Value))};
    end
    ...
    img_name = app.Full_Feature_set.(app.Structure_Idx_Name).ImgLabel{find(strcmp(app.Blue_Comp_Image.Items,app.Blue_Comp_Image.Value))};
