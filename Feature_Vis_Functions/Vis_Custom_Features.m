...
function [all_feature_vis, feat_count] = Vis_Custom_Features(I,mask,composite,features_needed,all_feature_vis,vis_params)


% Example features quantification silver stain content
if any(ismember(features_needed,(448:461)))
    ...
    overlap_num = length(find(ismember(features_needed,(448:461))));
    feat_count = feat_count+overlap_num;

    all_feature_vis = insert_vis(features_needed,(448:461),feat_vis,all_feature_vis,)
